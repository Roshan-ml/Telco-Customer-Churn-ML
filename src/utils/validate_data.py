...
def validate_telco_data(df) -> Tuple[bool, List[str]]:
    ...
    # Coerce TotalCharges to numeric within ge_df only (raw CSV stores it as string)
    # This does NOT modify the original dataframe passed in
    ge_df["TotalCharges"] = pd.to_numeric(ge_df["TotalCharges"], errors="coerce").fillna(0)
